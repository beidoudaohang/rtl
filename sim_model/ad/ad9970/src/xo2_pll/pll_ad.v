...
/* Module Version: 5.4 */
/* D:\Tools\lscc\diamond\2.2_x64\ispfpga\bin\nt64\scuba.exe -w -n pll_ad -lang verilog -synth synplify -arch xo2c00 -type pll -fin 45 -fclkop 360 -fclkop_tol 0.0 -fclkos 45 -fclkos_tol 0.0 -trimp 0 -phasep 0 -trimp_r -trims 0 -phases 0 -trims_r -phase_cntl STATIC -fb_mode 1 -lock -e  */
/* Wed Dec 02 16:36:07 2015 */


`timescale 1 ns / 1 ps
module pll_ad (CLKI, CLKOP, CLKOS, LOCK)/* synthesis syn_noprune=1 *//* synthesis NGD_DRC_MASK=1 */;// exemplar attribute pll_ad dont_touch true 
    input wire CLKI;
    output wire CLKOP;
    output wire CLKOS;
    output wire LOCK;
    ...
    EHXPLLJ PLLInst_0 (.CLKI(CLKI), .CLKFB(CLKOP_t), .PHASESEL1(scuba_vlo), 
        ...
        .PLLDATO2(), .PLLDATO1(), .PLLDATO0())
             /* synthesis FREQUENCY_PIN_CLKOS="45.000000" */
    ...
    // exemplar begin
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOS 45.000000
