...
//************************************************************************************************/
//**                                                                                            **/
//**   LE24512A  512K bit I2C EEPROM (VDD = 1.7V to 3.6V)                                    	**/
//**                                                                                            **/
//**   File Name        : LE24512A.v                                                         	**/
//**   Top Module       : LE24512A                                                           	**/
//**                                                                                            **/
//**    Feature         :                                                                       **/
//**                            Capacity                        512Kbit(64K x 8bit)             **/
...
module LE24512A (SDA, SCL, WP, S0, S1, S2);
...
//************************************************************************************************/
//**    Parameter for LE24512A (Slave-Pin, WP-Pin Infomation)                                 **/
//************************************************************************************************/
...
//************************************************************************************************/
//**    Parameter for LE24512A                                                                **/
//************************************************************************************************/
`define Memory_SIZE     512*1024                       	// 512K-bit (A0-A15)
`define Memory_MSB      15                             	// A0-A15
`define PAGE_SIZE_e     128                             // 128-byte page size (A0-A6)
`define PAGE_MSB_e      6                               // A0-A6
...
//************************************************************************************************/
//**    Specify for LE24512A   Timming Parameter (Output)					**/
//************************************************************************************************/
parameter               tWC=5000000-1;                  // Write Cycle 5ms
parameter               tAA=900-1;                      // Output valid from SCL

//************************************************************************************************/
//**    Specify Cheack for LE24512A   Timming Parameter (Input)                              	**/
//************************************************************************************************/
