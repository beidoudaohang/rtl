...
//************************************************************************************************/
//**                                                                                            **/
//**   LE24L042  4K bit I2C EEPROM (VDD = 1.7V to 3.6V)                                       	**/
//**                                                                                            **/
//**   File Name        : LE24L042.v                                                           	**/
//**   Top Module       : LE24L042                                                             	**/
//**                                                                                            **/
//**    Feature         :                                                                       **/
//**                            Capacity                        4Kbit(512 x 8bit)               **/
...
module LE24L042 (SDA, SCL);
//module LE24L042 (SDA, SCL, WP);
...
//************************************************************************************************/
//**    Parameter for LE24L042 (Slave-Pin, WP-Pin Infomation)                                   **/
//************************************************************************************************/
...
//************************************************************************************************/
//**    Parameter for LE24L042                                                                  **/
//************************************************************************************************/
`define Memory_SIZE     4*1024                         	// 4K-bit (A0-A8)
`define Memory_MSB      8                              	// A0-A8
...
//************************************************************************************************/
//**    Specify for LE24L042   Timming Parameter (Output)					**/
//************************************************************************************************/
parameter               tWC=10000000-1;                 // Write Cycle
parameter               tAA=900-1;                      // Output valid from SCL

//************************************************************************************************/
//**    Specify Cheack for LE24L042   Timming Parameter (Input)                               	**/
//************************************************************************************************/
