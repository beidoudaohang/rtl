...
/* Module Version: 5.4 */
/* D:\Tools\lscc\diamond\2.2_x64\ispfpga\bin\nt64\scuba.exe -w -n pll -lang verilog -synth synplify -arch xo2c00 -type pll -fin 45 -fclkop 360 -fclkop_tol 0.0 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -fb_mode 1 -lock -e  */
/* Fri Aug 07 16:07:46 2015 */


`timescale 1 ns / 1 ps
module pll_ad (CLKI, CLKOP, LOCK)/* synthesis syn_noprune=1 *//* synthesis NGD_DRC_MASK=1 */;// exemplar attribute pll dont_touch true 
    input wire CLKI;
    output wire CLKOP;
    output wire LOCK;
