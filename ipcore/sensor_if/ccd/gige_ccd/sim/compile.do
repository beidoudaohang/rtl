...
if { $data_channel == 1 } {
	...
	##	hispi_if_new 模块
	##	-------------------------------------------------------------------------------------
	vlog	../src/data_channel/ad9970_if/*.v
...
##	ref 3.编译测试代码
##	-------------------------------------------------------------------------------------
vlog	+incdir+../src	+define+TESTCASE=$TESTCASE	../testbench/tb_$TB_MODULE/*.v

##	-------------------------------------------------------------------------------------
##	ref 4.编译全局测试文件
##	-------------------------------------------------------------------------------------
if { $global_para == 1 } {
	vlog	+incdir+../src	+define+TESTCASE=$TESTCASE	../testbench/global/*.v
}
