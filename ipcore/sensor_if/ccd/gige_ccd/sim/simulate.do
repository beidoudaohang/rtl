...
#		vsim -t ps -novopt +notimingchecks -L unisims_ver -L secureip -L xilinxcorelib_ver work.glbl harness $TESTCASE\
	...
	if { $TB_MODULE == "mer"} {
		...
		vsim -t ps -novopt +notimingchecks -L unisims_ver -L secureip -L xilinxcorelib_ver -L machxo2 -L sc -L lptm -L pmi -L scm  work.glbl harness $TESTCASE\
		driver_spi_master\
		driver_ad9970\
		driver_ccd_sharp\
		ddr3_model_c3

	} elseif {$TB_MODULE == "ccd"} {
		vsim -t ps -novopt +notimingchecks -L unisims_ver -L secureip -L xilinxcorelib_ver work.glbl harness $TESTCASE
	}
}
