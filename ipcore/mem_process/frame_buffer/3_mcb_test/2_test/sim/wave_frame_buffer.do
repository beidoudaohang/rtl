...
add wave -noupdate -expand -group {wr_logic
...
WaveRestoreCursors {{Cursor 1} {136419400 ps} 1} {{Cursor 2} {145691100 ps} 1} {{Cursor 3} {18807775 ps} 0}
...
update
WaveRestoreZoom {1694908178 ps} {1861997202 ps}
