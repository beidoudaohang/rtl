...
add wave -noupdate -divider {New Divider}
add wave -noupdate -expand -group {ddr3
...
add wave -noupdate -expand -group {monitor_ddr3
...
WaveRestoreCursors {{Cursor 1} {136419400 ps} 1} {{Cursor 2} {145691100 ps} 1} {{Cursor 3} {208818837 ps} 0}
...
update
WaveRestoreZoom {207060725 ps} {211048430 ps}
